...
<head>
    ...
    <title>Hasil Penilaian Kinerja Pegawai</title>
    <style>
        table {
            width: 100%;
...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="section-content">
                ...
                <p><strong>Nama Pegawai:</strong> {{ $guru->nama_guru }}</p>
    ...
    <div class="signature" style="text-align: left">
        ...
        <p style="margin-bottom: 20px"><strong>Puskesmas UKUI</strong></p>
        <!-- Tambahkan isian tanda tangan atau nama kepala sekolah di bawah ini -->
        <p><strong>(Rosdiana, SKM)</strong></p>
    </div>

    <div class="footer">
        <p>Laporan Hasil Penilaian Kinerja Pegawai Puskesmas UKUI Periode {{ $periode ?? 'Tidan ada data' }}.</p>
    </div>
    </div>
</body>
