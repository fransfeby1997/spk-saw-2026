...
-->
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">SPK Penilaian Kinerja Pegawai</h5>
                </div>
                <div class="card-body">
                    <p class="card-text">
                        Sistem Pendukung Keputusan (SPK) Penilaian Kinerja Pegawai menggunakan metode Simple Additive Weighting (SAW)
                        adalah suatu sistem yang membantu dalam proses pengambilan keputusan terkait penilaian kinerja pegawai puskesmas.
...
<!--
                    ...
                    <ol>
                        <li>Input nilai kriteria untuk setiap pegawai.</li>
                        ...
                        <li>Simpan nilai terbobot ke dalam tabel nilai terbobot untuk setiap pegawai.</li>
                        <li>Simpan matriks normalisasi ke dalam tabel penilaian untuk setiap pegawai dan setiap kriteria.</li>
                        <li>Hitung nilai akhir dengan menjumlahkan nilai terbobot.</li>
                        <li>Hasil penilaian guru tersedia di dashboard, termasuk rata-rata nilai untuk setiap pegawai.</li>
                    </ol>
