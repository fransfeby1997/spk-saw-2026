...
Route::get('/penilaian', [PenilaianController::class, 'index'])->name('penilaian.index')->middleware(['auth', 'role:admin']);
Route::post('/penilaian', [PenilaianController::class, 'store'])->name('penilaian.store')->middleware(['auth', 'role:admin']);
Route::get('/cetak/hasil/penilaian/{guru_id}/{periode}', [CetakController::class, 'cetakHasilPenilaian'])->name('cetak.hasil.penilaian')->middleware(['auth', 'role:admin']);
